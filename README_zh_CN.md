...
适合 Codex 和 Claude Code 的 Web UI skill pack，用于审查、修复、润色和构建更成熟的网页 UI。
...
当前核心能力覆盖五个工作流：**Audit、Review、Fix、Polish 和 Build**。可安装的 skill 名称是 `webcraft-ui`，npm 包名是 `webcraft-skills`。
